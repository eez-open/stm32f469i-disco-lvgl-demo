...
static void event_handler_cb_heating_screen_obj1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_security_screen_obj3(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_lighting_screen_obj5(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
void create_screen_heating_screen() {
    ...
    lv_obj_set_size(obj, 800, 480);
    {
        ...
        }
        {
            ...
            create_user_widget_header(obj, getFlowState(flowState, 8), 5);
        }
        {
            // heating_button_1
        ...
        }
        {
            ...
            lv_obj_set_style_bg_img_opa(obj, 32, LV_PART_MAIN | LV_STATE_DISABLED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_heating_screen_obj1, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_zone_selector(obj, getFlowState(flowState, 29), 12);
        }
        {
            // account_box_1
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_account_box(obj, getFlowState(flowState, 30), 16);
...
void tick_screen_heating_screen() {
    void *flowState = getFlowState(0, 1);
    tick_user_widget_header(getFlowState(flowState, 8), 5);
    {
    ...
    tick_user_widget_zone_selector(getFlowState(flowState, 29), 12);
    tick_user_widget_account_box(getFlowState(flowState, 30), 16);
}
...
void create_screen_security_screen() {
    ...
    lv_obj_set_size(obj, 800, 480);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_header(obj, getFlowState(flowState, 6), 22);
        }
        {
            // heating_button_2
            lv_obj_t *obj = lv_btn_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_CHECKED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_label_set_text(obj, "");
                    lv_obj_add_event_cb(obj, event_handler_cb_security_screen_obj3, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_text_font(obj, &ui_font_bold_21, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_zone_selector(obj, getFlowState(flowState, 26), 29);
        }
        {
            // account_box_2
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_account_box(obj, getFlowState(flowState, 27), 33);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
        }
    }
}
...
void tick_screen_security_screen() {
    void *flowState = getFlowState(0, 2);
    tick_user_widget_header(getFlowState(flowState, 6), 22);
    {
    ...
    tick_user_widget_zone_selector(getFlowState(flowState, 26), 29);
    tick_user_widget_account_box(getFlowState(flowState, 27), 33);
}
...
void create_screen_lighting_screen() {
    ...
    lv_obj_set_size(obj, 800, 480);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_header(obj, getFlowState(flowState, 8), 39);
        }
        {
            // heating_button_3
            lv_obj_t *obj = lv_btn_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_img_opa(obj, 32, LV_PART_MAIN | LV_STATE_DISABLED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_label_set_text(obj, "Save");
                    lv_obj_add_event_cb(obj, event_handler_cb_lighting_screen_obj5, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_text_font(obj, &ui_font_bold_21, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_opa(obj, 64, LV_PART_MAIN | LV_STATE_DISABLED);
                }
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_zone_selector(obj, getFlowState(flowState, 28), 46);
        }
        {
            // account_box_3
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_account_box(obj, getFlowState(flowState, 29), 50);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
        }
    }
}
...
void tick_screen_lighting_screen() {
    void *flowState = getFlowState(0, 3);
    tick_user_widget_header(getFlowState(flowState, 8), 39);
    {
        const char *new_val = evalTextProperty(flowState, 14, 3, "Failed to evaluate Text in Label widget");
    ...
    tick_user_widget_zone_selector(getFlowState(flowState, 28), 46);
    tick_user_widget_account_box(getFlowState(flowState, 29), 50);
}
